...
const Event = () => {
  ...
  const Ticket = (props: { index: number }) => {
    ...
    return selectedIndex === props.index ? (
      <svg
        onClick={() => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <img src="../../arena_seating.jpeg" className="mt-10 w-[800px]" />
        ...
        <div className="flex flex-col ml-40">
          {selectedIndex !== undefined && (
            <div className="self-center text-white">
              You have selected seat {selectedIndex}, total {ethers.utils.formatEther(event.price)} CRO
            </div>
          )}
          {event.totalSupply > event.soldIds.length ? (
            <button
              className="mt-20 align-bottom bg-white btn text-primary hover:bg-secondary hover:text-white"
              onClick={() => {
                buyTicket({
            ...
            <button className="mt-20 align-bottom bg-white btn text-primary hover:bg-secondary hover:text-white">
              Soldout
            </button>
          )}
        </div>
